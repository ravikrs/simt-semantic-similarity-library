...
public class LsaSimilarityMeasure extends TextSimilarityMeasureBase {
	...
	public LsaSimilarityMeasure(File modelFile) throws IOException {
		...
		measure = new VectorComparator(new CachingVectorReader(new SSpaceVectorReader(sspace), cacheSize));
	}
